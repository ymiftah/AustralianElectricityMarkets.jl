import{_ as s,c as a,o as t,aA as l}from"./chunks/framework.XsoMnUa1.js";const n="/AustralianElectricityMarkets.jl/dev/assets/syiaqjf.DRT47ULX.png",e="/AustralianElectricityMarkets.jl/dev/assets/cqrvejz.C9mRD6qL.png",h="/AustralianElectricityMarkets.jl/dev/assets/utqtnbe.CxAmgVq5.png",k="/AustralianElectricityMarkets.jl/dev/assets/xrmgjyv.BiUUC3wJ.png",c=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/market_bids.md","filePath":"examples/market_bids.md","lastUpdated":null}'),r={name:"examples/market_bids.md"};function d(p,i,g,o,f,b){return t(),a("div",null,[...i[0]||(i[0]=[l(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
