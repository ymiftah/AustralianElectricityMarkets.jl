import{_ as i,o as t,c as a,aA as n}from"./chunks/framework.Bg8BcNkn.js";const l="/AustralianElectricityMarkets.jl/dev/assets/eiabtpq.WaE4c5xI.png",e="/AustralianElectricityMarkets.jl/dev/assets/cdpalpm.CoWin1-O.png",h="/AustralianElectricityMarkets.jl/dev/assets/tygpspk.t9MjLLYX.png",p="/AustralianElectricityMarkets.jl/dev/assets/ziazqyp.BiUUC3wJ.png",F=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/market_bids.md","filePath":"examples/market_bids.md","lastUpdated":null}'),k={name:"examples/market_bids.md"};function d(r,s,g,E,y,o){return t(),a("div",null,[...s[0]||(s[0]=[n(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">@show</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> date_range</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;">Dates.DateTime(&quot;2025-01-02T04:00:00&quot;):Dates.Minute(5):Dates.DateTime(&quot;2025-01-03T04:00:00&quot;)</span></span></code></pre></div><p>Set deterministic timseries</p><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>set_demand!(sys, db, date_range; resolution = interval)</span></span>
...
<span class="line"><span>set_market_bids!(sys, db, date_range)</span></span></code></pre></div><p>Derive forecasts from the deterministic timseries</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">transform_single_time_series!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p><img src="`+p+'" alt="" width="600px" height="450px"></p><p>This was not observed in the Economic dispatch example, and many factors can explain this behaviour. For instance:</p><ul><li><p>In the Australian Electricity market, the bids incorporate the on/off constraints: Coal power plant bid at lower costs than solar plants because it is more expensive for them to turn off, and they know they should be able to recoup the losses at time of low solar generation, where there is less competition.</p></li><li><p>Some generators may have hedged their risk with future contracts.</p></li></ul>',44)])])}const C=i(k,[["render",d]]);export{F as __pageData,C as default};
