import{_ as i,c as t,o as a,aA as n}from"./chunks/framework.XsoMnUa1.js";const l="/AustralianElectricityMarkets.jl/dev/assets/knkwyjr.MDeXcyeS.png",e="/AustralianElectricityMarkets.jl/dev/assets/yaldmap.DViLMu53.png",h="/AustralianElectricityMarkets.jl/dev/assets/fuuibqh.D2Hv117X.png",k="/AustralianElectricityMarkets.jl/dev/assets/rowjzjg.a7__Zkk9.png",f=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/economic_dispatch.md","filePath":"examples/economic_dispatch.md","lastUpdated":null}'),p={name:"examples/economic_dispatch.md"};function d(r,s,g,o,y,E){return a(),t("div",null,[...s[0]||(s[0]=[n(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
