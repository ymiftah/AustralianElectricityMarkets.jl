import{_ as s,o as a,c as t,aA as l}from"./chunks/framework.Bg8BcNkn.js";const n="/AustralianElectricityMarkets.jl/dev/assets/fydfjcr.io_VL-0A.png",e="/AustralianElectricityMarkets.jl/dev/assets/eetdobh.BCfxV11b.png",h="/AustralianElectricityMarkets.jl/dev/assets/lcgsusi.C4cYOo2S.png",k="/AustralianElectricityMarkets.jl/dev/assets/wcphzjc.BiUUC3wJ.png",c=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/market_bids.md","filePath":"examples/market_bids.md","lastUpdated":null}'),r={name:"examples/market_bids.md"};function d(p,i,g,o,f,b){return a(),t("div",null,[...i[0]||(i[0]=[l(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
