import{_ as i,c as t,o as a,aA as n}from"./chunks/framework.DuUd1na1.js";const l="/AustralianElectricityMarkets.jl/dev/assets/fsnsbpv.Dqw3n5MK.png",e="/AustralianElectricityMarkets.jl/dev/assets/sgevvta.DViLMu53.png",h="/AustralianElectricityMarkets.jl/dev/assets/ovdigqa.DhAF7OAq.png",k="/AustralianElectricityMarkets.jl/dev/assets/elfekkj.DQgbV49O.png",f=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/economic_dispatch.md","filePath":"examples/economic_dispatch.md","lastUpdated":null}'),p={name:"examples/economic_dispatch.md"};function d(g,s,r,o,y,E){return a(),t("div",null,[...s[0]||(s[0]=[n(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
