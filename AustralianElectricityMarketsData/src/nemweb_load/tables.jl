...
const _TABLE_SPECS = [
    ...
    (
        ...
        columns = [
            ...
            "CONSTRAINTVALUE", "STATUS", "AUTHORISEDDATE", "AUTHORISEDBY",
            "DYNAMICRHS", "DISPATCH", "PREDISPATCH", "STPASA", "MTPASA",
            "IMPACT", "SOURCE", "LIMITTYPE", "REASON", "MODIFICATIONS",
            "ADDITIONALNOTES", "P5MIN_SCOPE_OVERRIDE", "LRC", "LOR",
            "FORCE_SCADA", "SYSTEMSECURITY", "SSM_REGIONID", "SSM_GROUPID",
        ],
    ...
    (
        name = "GENCONSET",
        columns = [
            "GENCONSETID", "EFFECTIVEDATE", "VERSIONNO", "GENCONID",
            "GENCONEFFDATE", "GENCONVERSIONNO", "LASTCHANGED",
        ],
    ...
    (
        ...
        columns = [
            ...
            "COVERAGE", "MODIFICATIONS", "SYSTEMNORMAL", "OUTAGE",
        ],
