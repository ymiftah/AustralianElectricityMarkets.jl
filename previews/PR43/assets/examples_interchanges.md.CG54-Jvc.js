import{_ as s,o as a,c as t,aA as n}from"./chunks/framework.RqrAmmgJ.js";const l="/AustralianElectricityMarkets.jl/previews/PR43/assets/tfrqmwp.BKJVZe29.png",e="/AustralianElectricityMarkets.jl/previews/PR43/assets/kzdtfhg.CyXGsHRX.png",h="/AustralianElectricityMarkets.jl/previews/PR43/assets/drcvmur.LStAojEq.png",k="/AustralianElectricityMarkets.jl/previews/PR43/assets/yhmlbqg.aYd7Dj9w.png",r="/AustralianElectricityMarkets.jl/previews/PR43/assets/wtmokyv.BNnY-3kO.png",E=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/interchanges.md","filePath":"examples/interchanges.md","lastUpdated":null}'),d={name:"examples/interchanges.md"};function p(g,i,o,f,b,y){return a(),t("div",null,[...i[0]||(i[0]=[n(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">@show</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> date_range</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;">Dates.DateTime(&quot;2025-01-02T00:00:00&quot;):Dates.Minute(5):Dates.DateTime(&quot;2025-01-03T00:00:00&quot;)</span></span></code></pre></div><p>Set deterministic timseries</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">set_demand!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(sys, db, date_range; resolution </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> interval)</span></span>
...
<span class="line"><span style="--shiki-light:#dbab09;--shiki-light-font-weight:bold;--shiki-dark:#ffea7f;--shiki-dark-font-weight:bold;">└ </span><span style="--shiki-light:#959da5;--shiki-dark:#959da5;">@ AustralianElectricityMarkets ~/work/AustralianElectricityMarkets.jl/AustralianElectricityMarkets.jl/src/parser.jl:489</span></span></code></pre></div><p>Derive forecasts from the deterministic timseries</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">transform_single_time_series!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(</span></span>
...
</div><h1 id="Market-Clearing" tabindex="-1">Market Clearing <a class="header-anchor" href="#Market-Clearing" aria-label="Permalink to &quot;Market Clearing {#Market-Clearing}&quot;">​</a></h1><p><code>PowerSimulation.jl</code> provides different utilities to simulate an electricity system.</p><p>The following section demonstrates the definition of a market clearing problem, where all units in the NEM need to to be dispatched at the lowest cost to meet the aggregate demand at each region. This time, we also introduce interconnector constraints, which limits the flow of energy between regions due to physical limitations of power lines.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p><img src="`+k+`" alt="" width="600px" height="450px"></p><p>This was not observed in the Economic dispatch example, and many factors can explain this behaviour. For instance:</p><ul><li><p>In the Australian Electricity market, the bids incorporate the on/off constraints: Coal power plant bid at lower costs than solar plants because it is more expensive for them to turn off, and they know they should be able to recoup the losses at time of low solar generation, where there is less competition.</p></li><li><p>Some generators may have hedged their risk with future contracts.</p></li></ul><p>Finally, let&#39;s have a look at the interchanges, which are critical components of the NEM: They allow units generating in one region to export they production to other regions.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
