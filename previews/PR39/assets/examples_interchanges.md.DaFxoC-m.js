import{_ as s,o as a,c as t,aA as n}from"./chunks/framework.CXieu_F5.js";const l="/AustralianElectricityMarkets.jl/previews/PR39/assets/pdrjuxr.BKJVZe29.png",e="/AustralianElectricityMarkets.jl/previews/PR39/assets/scwbfhg.CyXGsHRX.png",h="/AustralianElectricityMarkets.jl/previews/PR39/assets/xamksen.LStAojEq.png",k="/AustralianElectricityMarkets.jl/previews/PR39/assets/hdrknbx.aYd7Dj9w.png",r="/AustralianElectricityMarkets.jl/previews/PR39/assets/hxnxvdo.BNnY-3kO.png",E=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/interchanges.md","filePath":"examples/interchanges.md","lastUpdated":null}'),d={name:"examples/interchanges.md"};function p(g,i,o,f,b,y){return a(),t("div",null,[...i[0]||(i[0]=[n(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
</div><p>Set the horizon to consider for the simulation</p><div class="language-@example vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">@example</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>interval = Minute(5)</span></span>
<span class="line"><span>horizon = Hour(24)</span></span>
<span class="line"><span>start_date = DateTime(2025, 1, 2, 0, 0)</span></span>
<span class="line"><span>date_range = start_date:interval:(start_date + horizon)</span></span>
<span class="line"><span>@show date_range</span></span>
<span class="line"><span></span></span>
<span class="line"><span>map([:BIDDAYOFFER_D, :BIDPEROFFER_D]) do table</span></span>
<span class="line"><span>    fetch_table_data(table, date_range)</span></span>
<span class="line"><span>end;</span></span>
<span class="line"><span>nothing #hide</span></span></code></pre></div><p>Set deterministic timseries</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">set_demand!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(sys, db, date_range; resolution </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> interval)</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">    draw</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(spec; figure </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (; size </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> (</span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">500</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">, </span><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">500</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">)))</span></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p><img src="`+r+'" alt="" width="500px" height="500px"></p><p>We see that a few lines are often saturated: V-S-MNSP1 connecting Victoria and South Australoa, or T-V-MSP1 connecting Victoria and Tasmania. The interfaces between New South Wales and Queensland, and New South Wales and Victoria are operated within their bounds and the power flows in both directions depending of the time of the day and resources available.</p>',49)])])}const w=s(d,[["render",p]]);export{E as __pageData,w as default};
