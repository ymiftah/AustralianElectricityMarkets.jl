import{_ as s,o as t,c as a,aA as l}from"./chunks/framework.ahbMZ4r0.js";const n="/AustralianElectricityMarkets.jl/previews/PR60/assets/dxczvfl.D91AXvLr.png",e="/AustralianElectricityMarkets.jl/previews/PR60/assets/ixqioky.CSYODRxn.png",h="/AustralianElectricityMarkets.jl/previews/PR60/assets/vemwcvz.Dl2sB-er.png",k="/AustralianElectricityMarkets.jl/previews/PR60/assets/jjnnnks.BiUUC3wJ.png",c=JSON.parse('{"title":"Market Clearing","description":"","frontmatter":{},"headers":[],"relativePath":"examples/market_bids.md","filePath":"examples/market_bids.md","lastUpdated":null}'),r={name:"examples/market_bids.md"};function d(p,i,g,o,f,b){return t(),a("div",null,[...i[0]||(i[0]=[l(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
<span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">@show</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> date_range</span></span></code></pre></div><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;">Dates.DateTime(&quot;2025-01-02T04:00:00&quot;):Dates.Minute(5):Dates.DateTime(&quot;2025-01-03T04:00:00&quot;)</span></span></code></pre></div><p>Set deterministic time series</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#005CC5;--shiki-dark:#79B8FF;">set_demand!</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">(sys, db, date_range; resolution </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">=</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> interval)</span></span>
...
</div><h2 id="Define-the-problem" tabindex="-1">Define the problem <a class="header-anchor" href="#Define-the-problem" aria-label="Permalink to &quot;Define the problem {#Define-the-problem}&quot;">​</a></h2><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">end</span></span></code></pre></div><p><img src="`+k+'" alt="" width="600px" height="450px"></p><p>This was not observed in the Economic dispatch example, and many factors can explain this behaviour. For instance:</p><ul><li><p><strong>Negative Bidding</strong>: In the NEM, many generators (especially coal) have high &quot;cycling costs&quot;: it is expensive for them to turn off and restart. To avoid this, they often bid at very low or even negative prices, ensuring they are dispatched even when demand is low or renewables are abundant.</p></li><li><p><strong>Contractual Obligations</strong>: Some generators may have hedged their risk with future contracts, requiring them to generate regardless of the spot price.</p></li><li><p><strong>Strategic Behavior</strong>: The 10-band bidding system allows for complex strategies that simple cost-minimization models do not capture.</p></li></ul>',49)])])}const E=s(r,[["render",d]]);export{c as __pageData,E as default};
