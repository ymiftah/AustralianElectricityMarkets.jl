import{_ as s,o as a,c as t,aA as l}from"./chunks/framework.C8gFyWxF.js";const n="/AustralianElectricityMarkets.jl/previews/PR44/assets/taclrfp.io_VL-0A.png",e="/AustralianElectricityMarkets.jl/previews/PR44/assets/hatzhfl.BCfxV11b.png",h="/AustralianElectricityMarkets.jl/previews/PR44/assets/xopmpym.C4cYOo2S.png",k="/AustralianElectricityMarkets.jl/previews/PR44/assets/nzynphd.BiUUC3wJ.png",c=JSON.parse('{"title":"Setup the system","description":"","frontmatter":{},"headers":[],"relativePath":"examples/market_bids.md","filePath":"examples/market_bids.md","lastUpdated":null}'),r={name:"examples/market_bids.md"};function d(p,i,g,o,f,b){return a(),t("div",null,[...i[0]||(i[0]=[l(`<div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
...
</div><h1 id="Market-Clearing" tabindex="-1">Market Clearing <a class="header-anchor" href="#Market-Clearing" aria-label="Permalink to &quot;Market Clearing {#Market-Clearing}&quot;">​</a></h1><p><code>PowerSimulations.jl</code> provides different utilities to simulate an electricity system.</p><p>The following section demonstrates the definition of a market clearing problem, where all units in the NEM need to to be dispatched at the lowest cost to meet the aggregate demand at each region. In this example, we ignore network constraints to simplify the problem, and adopt a &quot;Copper Plate&quot; formulation.</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">begin</span></span>
